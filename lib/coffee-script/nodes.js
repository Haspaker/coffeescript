...
(function() {
  ...
  exports.Call = Call = (function(superClass1) {
    ...
    Call.prototype.pipe = function(arg) {
      var _arg, i, j, len1, placeholder, ref3;
      placeholder = false;
      ref3 = this.args;
      for (i = j = 0, len1 = ref3.length; j < len1; i = ++j) {
        _arg = ref3[i];
        if ((_arg instanceof Value) && (_arg.base instanceof IdentifierLiteral) && (_arg.base.value === '__')) {
          this.args[i] = arg;
          placeholder = true;
        }
      }
  ...
  exports.Parens = Parens = (function(superClass1) {
    ...
    Parens.prototype.compileNode = function(o) {
      var bare, block, contains_placeholder_literal, expr, f, fragments, is_placeholder, param;
      is_placeholder = function(node) {
        return (node instanceof Value) && (node.base instanceof IdentifierLiteral) && (node.base.value === '__');
      };
      contains_placeholder_literal = false;
      this.traverseChildren(false, function(node) {
        if ((node instanceof Value) && (node.base instanceof IdentifierLiteral) && (node.base.value === '__') && (!node.is_placeholder)) {
          node.is_placeholder = true;
          return contains_placeholder_literal = true;
        }
      });
      if (contains_placeholder_literal && (this.body.expressions.length === 1)) {
        param = new Param(new IdentifierLiteral('__'));
        block = new Block([this.body.unwrap()]);
        f = new Code([param], this.body, 'func');
